...
public class ProvisioningTest {
    ...
    public void timeoutLaunchingJnlp() throws Exception {
        final SlaveOptions opts =
                j.defaultSlaveOptions().getBuilder().startTimeout(7000).build();
    ...
    public void reportOfflineCauseInCloudStats() throws Exception {
        ...
        List<PhaseExecutionAttachment> attachments =
                pa.getPhaseExecution(ProvisioningActivity.Phase.COMPLETED).getAttachments();
        ...
        slave.toComputer()
                .setTemporarilyOffline(
                        true, new OfflineCause.ChannelTermination(new RuntimeException("Broken alright")));
        slave.getComputer().deleteSlave();
